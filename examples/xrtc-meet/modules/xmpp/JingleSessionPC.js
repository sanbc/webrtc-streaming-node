...
JingleSessionPC.prototype.accept = function () {
    ...
    var self = this;
    this.peerconnection.setLocalDescription(new WebRTC.RTCSessionDescription({type: 'answer', sdp: sdp}),
        function () {
...
JingleSessionPC.prototype.setRemoteDescription = function (elem, desctype) {
    ...
    var remotedesc = new WebRTC.RTCSessionDescription({type: desctype, sdp: this.remoteSDP.raw});
...
JingleSessionPC.prototype.addIceCandidate = function (elem) {
    ...
    if (!this.peerconnection.remoteDescription && this.peerconnection.signalingState == 'have-local-offer') {
        ...
        if (iscomplete) {
            ...
            try {
                this.peerconnection.setRemoteDescription(new WebRTC.RTCSessionDescription({type: 'pranswer', sdp: this.remoteSDP.raw }),
                    function() {
                    },
                    function(e) {
...
JingleSessionPC.prototype._modifySources = function (successCallback, queueCallback) {
    ...
    sdp.raw = sdp.session + sdp.media.join('');
    this.peerconnection.setRemoteDescription(new WebRTC.RTCSessionDescription({type: 'offer', sdp: sdp.raw}),
        function() {
...
JingleSessionPC.prototype.addStream = function (stream, callback) {
	console.log("JingleSessionPC.prototype.addStream...");
    var self = this;
