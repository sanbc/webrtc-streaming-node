...
function TraceablePeerConnection(ice_config, constraints, session) {
    ...
    this.peerconnection = new WebRTC.RTCPeerConnection(ice_config, constraints);
    this.updateLog = [];
    this.stats = {};
...
TraceablePeerConnection.prototype.setRemoteDescription
    ...
    //description = this.simulcast.mungeRemoteDescription(description); //Aruna --check it later
