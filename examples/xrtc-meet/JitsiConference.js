...
function JitsiConference(options) {
    ...
    if(!options.name || options.name.toLowerCase() !== options.name) {
        ...
        console.log("Invalid conference name (no conference name passed or it contains invalid characters like capital letters)!");
         return;
    }
...
JitsiConference.prototype.addTrack = function (track) {
	console.log("JitsiConference.prototype.addTrack");
